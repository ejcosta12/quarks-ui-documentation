        ...
        kEfd: function (t, e, i) {
            ...
            var X = function (t, e, i) {
                    ...
                    (this.reservedWordsStrict = q(n)),
                        (this.reservedWordsStrictBind = q(
                            n + ' ' + a.strictBind,
                        )),
                        (this.input = String(e)),
                        (this.containsEsc = !1),
            ...
            (G.isLet = function () {
                ...
                (G.parseStatement = function (t, e, i) {
                    ...
                    switch ((this.isLet() && ((r = E._var), (s = 'let')), r)) {
                        ...
                        case E._class:
                            return (
                                t && this.unexpected(), this.parseClass(n, !0)
                            );
                        case E._if:
                ...
                (G.parseFunctionStatement = function (t, e, i) {
                    return (
                        this.next(),
                        this.parseFunction(t, Y | (i ? 0 : Z), !1, e)
                    );
                }),
            ...
            (G.parseTryStatement = function (t) {
                ...
                return (
                    (t.finalizer = this.eat(E._finally)
                        ? this.parseBlock()
                        : null),
                    t.handler ||
                        t.finalizer ||
            ...
            (G.parseFunction = function (t, e, i, s) {
                ...
                return (
                    ...
                    e & Y ||
                        (t.id =
                            this.type === E.name ? this.parseIdent() : null),
                ...
                (G.parseExportSpecifiers = function (t) {
                    ...
                    for (this.expect(E.braceL); !this.eat(E.braceR); ) {
                        if (i) i = !1;
                            ...
                            (this.expect(E.comma),
                            this.afterTrailingComma(E.braceR))
                        )
                            break;
                        var s = this.startNode();
                    ...
                    switch ((void 0 === e && (e = 0), t.type)) {
                        case 'Identifier':
                            this.strict &&
                                ...
                                0 !== e &&
                                    5 !== e &&
                                    this.declareName(t.name, e, t.start);
                            break;
                        case 'MemberExpression':
                            e &&
                                this.raiseRecoverable(
            ...
            (et.checkPropClash = function (t, e, i) {
                ...
                (et.parseMaybeAssign = function (t, e, i) {
                    ...
                    if (
                        (i && (h = i.call(this, h, o, p)), this.type.isAssign)
                    ) {
                ...
                (et.parseExprOp = function (t, e, i, s, r) {
                    ...
                    if (null != n && (!r || this.type !== E._in) && n > s) {
                        var a =
                                this.type === E.logicalOR ||
                                this.type === E.logicalAND,
                            o = this.value;
                        this.next();
                        var p = this.start,
                            h = this.startLoc,
            ...
            (rt.enterScope = function (t) {
                ...
                (rt.declareName = function (t, e, i) {
                    ...
                    if (2 === e) {
                        ...
                        (s =
                            r.lexical.indexOf(t) > -1 || r.var.indexOf(t) > -1),
                            r.lexical.push(t);
                    } else if (4 === e) {
            ...
            (lt.initialContext = function () {
                ...
                (E.braceL.updateContext = function (t) {
                    this.context.push(
                        this.braceIsBlock(t) ? ct.b_stat : ct.b_expr,
                    ),
                        (this.exprAllowed = !0);
                }),
                ...
                (E.parenL.updateContext = function (t) {
                    var e =
                        ...
                        t === E._with ||
                        t === E._while;
                    this.context.push(e ? ct.p_stat : ct.p_expr),
                        (this.exprAllowed = !0);
                }),
                (E.incDec.updateContext = function () {}),
                (E._function.updateContext = E._class.updateContext = function (
                    t,
                ) {
                    t.beforeExpr &&
                    t !== E.semi &&
            ...
            (ft.prototype.reset = function (t, e, i) {
                ...
                (dt.regexp_pattern = function (t) {
                    ...
                    for (
                        var e = 0, i = t.backReferenceNames;
                        e < i.length;
                        e += 1
                    ) {
                        var s = i[e];
                ...
                (dt.regexp_eatQuantifier = function (t, e) {
                    return (
                        void 0 === e && (e = !1),
                        !!this.regexp_eatQuantifierPrefix(t, e) &&
                            (t.eat(63), !0)
                    );
                }),
                ...
                (dt.regexp_groupSpecifier = function (t) {
                    if (t.eat(63)) {
                        if (this.regexp_eatGroupName(t))
                            return (
                                -1 !==
                                    t.groupNames.indexOf(t.lastStringValue) &&
                ...
                (dt.regexp_eatAtomEscape = function (t) {
                    return (
                        ...
                        (t.switchU &&
                            (99 === t.current() &&
                                t.raise('Invalid unicode escape'),
                            t.raise('Invalid escape')),
                        !1)
                    );
                }),
                (dt.regexp_eatBackReference = function (t) {
                    ...
                    if (this.regexp_eatDecimalEscape(t)) {
                        ...
                        if (t.switchU)
                            return (
                                i > t.maxBackReference &&
                                    (t.maxBackReference = i),
                                !0
                            );
                ...
                (dt.regexp_eatKGroupName = function (t) {
                    if (t.eat(107)) {
                        if (this.regexp_eatGroupName(t))
                            return (
                                t.backReferenceNames.push(t.lastStringValue), !0
                            );
                ...
                (dt.regexp_eatCharacterEscape = function (t) {
                    return (
                        ...
                        this.regexp_eatRegExpUnicodeEscapeSequence(t) ||
                        (!t.switchU &&
                            this.regexp_eatLegacyOctalEscapeSequence(t)) ||
                ...
                (dt.regexp_eatControlLetter = function (t) {
                    var e = t.current();
                    return (
                        !!gt(e) && ((t.lastIntValue = e % 32), t.advance(), !0)
                    );
                }),
                ...
                (dt.regexp_validateUnicodePropertyNameAndValue = function (
                    t,
                    e,
                    i,
                ) {
                ...
                (dt.regexp_validateUnicodePropertyNameOrValue = function (
                    t,
                    e,
                ) {
                    -1 === ut.$LONE.indexOf(e) &&
                ...
                (dt.regexp_eatHexDigits = function (t) {
                    ...
                    for (t.lastIntValue = 0; _t((i = t.current())); )
                        (t.lastIntValue = 16 * t.lastIntValue + kt(i)),
                            t.advance();
                    return t.pos !== e;
                }),
                ...
                (dt.regexp_eatFixedHexDigits = function (t, e) {
                    ...
                    for (var s = 0; s < e; ++s) {
                        ...
                        (t.lastIntValue = 16 * t.lastIntValue + kt(r)),
                            t.advance();
                    }
                    return !0;
                });
            var wt = function (t) {
                    (this.type = t.type),
                        ...
                        (this.end = t.end),
                        t.options.locations &&
                            (this.loc = new D(t, t.startLoc, t.endLoc)),
            ...
            (Et.next = function () {
                ...
                (Et.readToken_pipe_amp = function (t) {
                    ...
                    return e === t
                        ? this.finishOp(
                              124 === t ? E.logicalOR : E.logicalAND,
                              2,
                          )
                        : 61 === e
                        ? this.finishOp(E.assign, 2)
                        : this.finishOp(
                              124 === t ? E.bitwiseOR : E.bitwiseAND,
                              1,
                          );
                }),
                ...
                (Et.readRegexp = function () {
                    ...
                    var o =
                        this.regexpState || (this.regexpState = new ft(this));
                    o.reset(i, r, a),
                ...
                (Et.readNumber = function (t) {
                    ...
                    var i =
                        this.pos - e >= 2 && 48 === this.input.charCodeAt(e);
                    i && this.strict && this.raise(e, 'Invalid number'),
                        i &&
                            /[89]/.test(this.input.slice(e, this.pos)) &&
                            (i = !1);
                    ...
                    for (var t = '', e = this.pos; ; ) {
                        ...
                        if (
                            ...
                            return this.pos !== this.start ||
                                ...
                                : 36 === i
                                ? ((this.pos += 2),
                                  this.finishToken(E.dollarBraceL))
            ...
            (qt.jsxTagStart.updateContext = function () {
                this.context.push(Ut),
                    this.context.push(Bt),
                    (this.exprAllowed = !1);
            }),
                        ...
                        return (function (t, e) {
                            return (function (e) {
                                ...
                                return (
                                    ...
                                    (i.prototype.jsx_readNewLine = function (
                                        t,
                                    ) {
                                        var e,
                                    ...
                                    (i.prototype.jsx_parseOpeningElementAt = function (
                                        t,
                                        e,
                                    ) {
                                    ...
                                    (i.prototype.jsx_parseClosingElementAt = function (
                                        t,
                                        e,
                                    ) {
                                        var i = this.startNodeAt(t, e),
                                    ...
                                    (i.prototype.jsx_parseElementAt = function (
                                        t,
                                        e,
                                    ) {
                                        var i = this.startNodeAt(t, e),
                                            s = [],
                                            r = this.jsx_parseOpeningElementAt(
                                                t,
                                                e,
                                            ),
                                            n = null;
                                                ...
                                                switch (this.type) {
                                                    case qt.jsxTagStart:
                                                        if (
                                                            ...
                                                            n = this.jsx_parseClosingElementAt(
                                                                t,
                                                                e,
                                                            );
                                                            break t;
                                    ...
                                    (i.prototype.parseExprAtom = function (t) {
                                        return this.type === qt.jsxText
                                            ...
                                            : e.prototype.parseExprAtom.call(
                                                  this,
                                                  t,
                                              );
                                    }),
                                    (i.prototype.readToken = function (t) {
                                        ...
                                        return 60 === t &&
                                            ...
                                            ? (++this.pos,
                                              this.finishToken(qt.jsxTagStart))
                                            : e.prototype.readToken.call(
                                                  this,
                                                  t,
                                              );
                                    }),
                                    (i.prototype.updateContext = function (t) {
                                        if (this.type == Tt.braceL) {
                                            ...
                                            i == Bt
                                                ...
                                                : e.prototype.updateContext.call(
                                                      this,
                                                      t,
                                                  ),
                                                (this.exprAllowed = !0);
                                            ...
                                            if (
                                                ...
                                                return e.prototype.updateContext.call(
                                                    this,
                                                    t,
                                                );
            ...
            function ie(t, e, i) {
                ...
                var s = Math.max(e.line - 5, 0),
                    ...
                    n = String(r).length,
                    a = t.split('\n').slice(s, r),
                    o = a[a.length - 1].slice(0, e.column).replace(/\t/g, '  ')
                        .length,
                    p = a
                        .map(function (t, e) {
                            return (
                    ...
                    addDeclaration: function (t, e) {
                        for (var i = 0, s = Kt(t); i < s.length; i += 1) {
                            ...
                            (this.declarations[n] = a),
                                this.isBlockScope &&
                                    (this.functionScope.blockScopedDeclarations[
                                        n
                                    ] ||
                                        (this.functionScope.blockScopedDeclarations[
                                            n
                    ...
                    if ('Property' === s.type) {
                        ...
                        (l = s.argument),
                            ...
                            a.push(function (e, i, a) {
                                var o = s.program.getObjectWithoutPropertiesHelper(
                                    t,
                                );
                                t.overwrite(
                                    s.start,
            ...
            var ce = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.createScope = function () {
                        var t = this;
                        (this.parentIsFunction = /Function/.test(
                            this.parent.type,
                        )),
                            (this.isFunctionBlock =
                                this.parentIsFunction ||
                                'Root' === this.parent.type),
                            (this.scope = new Zt({
                    ...
                    (e.prototype.getThisAlias = function () {
                        return (
                            this.thisAlias ||
                                (this.thisAlias = this.scope.createIdentifier(
                                    'this',
                                )),
                            this.thisAlias
                        );
                    ...
                    (e.prototype.transpile = function (e, i) {
                        ...
                        if (
                            ...
                            if (
                                'ArrowFunctionExpression' === this.parent.type
                            ) {
                                var p = this.body[0];
                                o.length
                                    ? (e
                    ...
                    (e.prototype.transpileParameters = function (
                        t,
                        e,
                        i,
                        s,
                    ...
                    (e.prototype.transpileBlockScopedIdentifiers = function (
                        t,
                    ) {
                        var e = this;
                        Object.keys(this.scope.blockScopedDeclarations).forEach(
                            function (i) {
                                for (
                                    var s = 0,
                                        r = e.scope.blockScopedDeclarations[i];
                                    s < r.length;
                                    s += 1
                                ) {
                                    var n = r[s],
                ...
                if (r) {
                    for (n = 0; n < e.length; n += 1) {
                        ...
                        'SpreadElement' === p.type
                            ...
                            : (t.prependRight(p.start, '['),
                              t.prependRight(p.end, ']'));
                    }
                    return !0;
                }
                var h = e[a],
                    ...
                    (e.prototype.transpile = function (e, i) {
                        if (
                            ...
                            if (this.elements.length) {
                                ...
                                s &&
                                    /\s*,/.test(
                                        e.original.slice(s.end, this.end),
                                    ) &&
            ...
            function ye(t, e) {
                ...
                if (i && 'const' === i.kind)
                    throw new se(t.name + ' is read-only', t);
            }
            var ge = (function (t) {
                    function e() {
                        t.apply(this, arguments);
                    ...
                    return (
                        ...
                        (e.prototype.transpileDestructuring = function (t) {
                            ...
                            n.forEach(function (t, i) {
                                ...
                                'ExpressionStatement' ===
                                this.unparenthesizedParent().type
                            ...
                            if ('Identifier' === r.type)
                                ...
                                'Identifier' === r.property.type
                                    ? (a = r.computed
                                          ...
                                          : r.property.name)
                                    : ((a = i.createDeclaration('property')),
                                      (p = !0)),
                                    'Identifier' === r.object.type
                                        ? (n = i.resolveName(r.object.name))
                                        : ((n = i.createDeclaration('object')),
                                          (o = !0)),
                                    r.start === h.start
                                        ? o && p
                                            ? (t.prependRight(
                                ...
                                if (
                                    (1 === this.arguments.length
                                        ? 'SpreadElement' === n.type &&
                                          (e.remove(n.start, n.argument.start),
                                          (r = !0))
                                        : (r = ue(
                                              e,
                                              this.arguments,
                                    ...
                                    if (
                                        ...
                                        'Identifier' === this.callee.object.type
                                    )
                                        s = this.callee.object.name;
                                    else {
                                        s = this.findScope(
                                            !0,
                                        ).createDeclaration('ref');
                    ...
                    return (
                        ...
                        (e.prototype.transpile = function (e, i, s, r) {
                            ...
                            if (i.classes) {
                                ...
                                l
                                    ? e.appendLeft(l.end, u)
                                    : e.prependRight(this.start, u),
            ...
            var Se = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.initialise = function (e) {
                            this.id
                                ? ((this.name = this.id.name),
                                  this.findScope(!0).addDeclaration(
                                      this.id,
                                      'class',
                                  ))
                                : (this.name = this.findScope(
                                      !0,
                                  ).createIdentifier('defaultExport')),
                                t.prototype.initialise.call(this, e);
                        }),
                        (e.prototype.transpile = function (t, e) {
                            if (e.classes) {
                                ...
                                var a = this.start;
                                this.id
                                    ? (t.overwrite(a, this.id.start, 'var '),
                                      (a = this.id.end))
                ...
                Ae = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.initialise = function (e) {
                            if (e.moduleExport)
                                throw new se('export is not supported', this);
                            t.prototype.initialise.call(this, e);
                        }),
                        e
                    );
                            ...
                            if (
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        var o = n.instances[a].findNearest(
                                            /Function/,
                                        );
                                        if (o && o.depth > this.depth) {
                                            this.shouldRewriteAsFunction = !0;
                                            for (
                                                var p = 0, h = this.thisRefs;
                                                p < h.length;
                                                p += 1
                                            ) {
                                                var c = h[p];
                    ...
                    return (
                        ...
                        (e.prototype.transpile = function (e, i) {
                            ...
                            if (this.shouldRewriteAsFunction) {
                                ...
                                var o = Object.keys(this.reassigned).map(
                                    function (t) {
                                        return (
                                            a[t].outer +
                                            ' = ' +
                ...
                Re = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.initialise = function (e) {
                            ...
                            this.body.createScope(),
                                this.id &&
                                    this.body.scope.addDeclaration(
                                        this.id,
                                        'function',
                                    ),
                                t.prototype.initialise.call(this, e);
            ...
            var je = (function (t) {
                            ...
                            if (
                                (function t(e, i) {
                                    return 'MemberExpression' === e.type
                                        ...
                                        : 'Identifier' === e.type
                                        ? !i ||
                                          (!/(Function|Class)Expression/.test(
                                              i.type,
                                          ) &&
                ...
                Ve = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.initialise = function (e) {
                            if (e.moduleImport)
                                throw new se('import is not supported', this);
                            t.prototype.initialise.call(this, e);
                        }),
                        e
                    );
            ...
            var Xe = (function (t) {
                        ...
                        (e.prototype.transpile = function (e, i) {
                            ...
                            if (r) {
                                ...
                                for (a = 0; a < r; a += 1)
                                    if (
                                        'JSXSpreadAttribute' ===
                                        this.attributes[a].type
                                    ) {
                                        h = !0;
                                        break;
                                    }
                                for (
                                    n = this.attributes[0].end, a = 0;
                                    a < r;
                                    a += 1
                                ) {
                ...
                Ke = {
                    ...
                    JSXFragment: We,
                    JSXOpeningElement: ze,
                    JSXOpeningFragment: He,
                        ...
                        return (
                            ...
                            (e.prototype.initialise = function () {
                                'string' == typeof this.value &&
                                    this.program.indentExclusionElements.push(
                                        this,
                                    );
                            }),
                            (e.prototype.transpile = function (t, e) {
                        ...
                        return (
                            ...
                            (e.prototype.transpile = function (e, i) {
                                ...
                                if (n && i.computedProperty) {
                                    ...
                                    'VariableDeclarator' === this.parent.type &&
                                    1 ===
                                        this.parent.parent.declarations
                                            .length &&
                                    'Identifier' === this.parent.id.type
                                        ? ((f = !0),
                                          (m =
                                              this.parent.id.alias ||
                                              this.parent.id.name))
                                        : (('AssignmentExpression' ===
                                              this.parent.type &&
                                              'ExpressionStatement' ===
                        ...
                        return (
                            ...
                            (e.prototype.initialise = function (t) {
                                (this.loop = this.findNearest(xe)),
                                    (this.nearestFunction = this.findNearest(
                                        /Function/,
                                    )),
                                    this.loop &&
                                        (!this.nearestFunction ||
                                            this.loop.depth >
                                                this.nearestFunction.depth) &&
                                        ((this.loop.canReturn = !0),
                                        (this.shouldWrap = !0)),
                                    this.argument &&
                                        this.argument.initialise(t);
                            }),
                            (e.prototype.transpile = function (t, e) {
                                var i =
                                    this.shouldWrap &&
                                ...
                                this.argument
                                    ? (i &&
                                      ...
                                      i &&
                                          t.appendLeft(this.argument.end, ' }'))
                        ...
                        return (
                            ...
                            (e.prototype.initialise = function (t) {
                                if (t.classes) {
                                    ...
                                    var e = this.findNearest('ClassBody')
                                        .parent;
                                    if (
                                        ((this.superClassName =
                                            e.superClass &&
                            ...
                            (e.prototype.transpile = function (t, e) {
                                if (e.classes) {
                                    ...
                                    if (s && 'CallExpression' === s.type) {
                                        this.noCall ||
                                            t.appendLeft(s.callee.end, '.call');
                    ...
                    TaggedTemplateExpression: (function (t) {
                        ...
                        return (
                            ...
                            (e.prototype.transpile = function (e, i) {
                                if (
                                    i.templateString &&
                                    i.dangerousTaggedTemplateString
                                ) {
                                    var s = this.quasi.expressions
                                        ...
                                        n = this.quasi.quasis
                                            ...
                                            .join(', '),
                                        a = this.program.templateLiteralQuasis[
                                            n
                                        ];
                                    a ||
                    ...
                    ThisExpression: (function (t) {
                        ...
                        return (
                            ...
                            (e.prototype.initialise = function (t) {
                                ...
                                if (t.letConst)
                                    for (
                                        var i = this.findNearest(xe);
                                        i && i.depth > e.depth;

                                    )
                                        i.thisRefs.push(this),
                                            (i = i.parent.findNearest(xe));
                                if (t.arrow) {
                                    var s = this.findNearest(
                                        'ArrowFunctionExpression',
                                    );
                                    s &&
                                        s.depth > e.depth &&
                            ...
                            (e.prototype.transpile = function (t, e) {
                                ...
                                if (
                                    ...
                                    this.declarations.forEach(function (r, o) {
                                        ...
                                        (a = r.end),
                                            (n = 'Identifier' !== r.id.type);
                                    }),
                                        n &&
                                            this.end > a &&
                                            t.overwrite(a, this.end, '', {
                                                contentOnly: !0,
                                            });
                                } else
                        ...
                        return (
                            ...
                            (e.prototype.initialise = function (e) {
                                ...
                                'let' === i &&
                                    'ForStatement' ===
                                        this.parent.parent.type &&
                                    (i = 'for.let'),
                                    this.parent.scope.addDeclaration(
                                        this.id,
                                        i,
                                    ),
                                    t.prototype.initialise.call(this, e);
                            ...
                            (e.prototype.isLeftDeclaratorOfLoop = function () {
                                return (
                                    ...
                                    this.parent.parent.left.declarations[0] ===
                                        this
                                );
                            }),
                            e
            ...
            function Ze(t, e, i, s) {
                (this.type = 'Root'),
                    ...
                    (function t(e, i) {
                        if (e)
                            if ('length' in e)
                                for (var s = e.length; s--; ) t(e[s], i);
                            else if (!e.__wrapped) {
                                (e.__wrapped = !0),
                                    $e[e.type] ||
                                        ($e[e.type] = Object.keys(e).filter(
                                            function (t) {
                                ...
                                e.program.magicString.addSourcemapLocation(
                                    e.start,
                                ),
                                    e.program.magicString.addSourcemapLocation(
                                        e.end,
                ...
                for (
                    var a = 0, o = this.indentExclusionElements;
                    a < o.length;
                    a += 1
                )
...
//# sourceMappingURL=bac1b955-a307768d97e26b1e070f.js.map
